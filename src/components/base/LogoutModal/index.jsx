              ...
              >
                <div className="flex w-full justify-between items-center">
                  <button
                    ...
                    type="submit"
                    className="w-[10.625rem] mt-28 h-14 bg-primary text-white bg-[primary] focus:ring-4 focus:outline-none  font-bold rounded-lg text-lg px-5 py-2.5 text-center "
                  >
                    Logout
                  </button>
                  <button
                    ...
                    className="text-white w-[10.625rem] mt-28 h-14  bg-[#F70000] focus:ring-4 focus:outline-none  font-bold rounded-lg text-lg px-5 py-2.5 text-center "
                  >
                    Cancel
                  </button>
                </div>
